            ...
            switch (choice) {
                ...
                case 4 -> {
                    ...
                    if (updatedTrainee != null) {
                        ...
                        serviceFacade.updateTrainee(id, updatedTrainee);
                ...
                case 5 -> {
                    ...
                    if (updatedTrainer != null) {
                        ...
                        serviceFacade.updateTrainer(id, updatedTrainer);
                ...
                case 13 -> {
                    ...
                    serviceFacade.findAllTrainees().values().forEach(entity -> System.out.println(entity.toString()));

                }
                case 14 -> {
                    System.out.println("All Trainers:");
                    serviceFacade.findAllTrainers().values().forEach(entity -> System.out.println(entity.toString()));
                }
                case 15 -> {
                    System.out.println("All Trainings:");
                    serviceFacade.findAllTrainings().values().forEach(entity -> System.out.println(entity.toString()));
                }
                case 16 -> {
